...
$detail = mysqli_real_escape_string($conn,$_POST['detail']);
 ...
 if($_POST['action']=="add")
 {
  ...
  $sql = $conn->query("INSERT INTO branch (branch,department,detail) VALUES ('$branch','$department','$detail')") ;
 ...
 $id = mysqli_real_escape_string($conn,$_POST['id']);	
   $sql = $conn->query("UPDATE  branch  SET  branch  = '$branch', department  = '$department', detail  = '$detail'  WHERE  id  = '$id'");
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-primary">
						...
						<div class="form-group">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Password">department </label>
								<div class="col-sm-10">
	                        <textarea class="form-control" id="address" name="department"><?php echo $department;?></textarea >
								</div>
							</div>
